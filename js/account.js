...
(function() {
  ...
  function ensureAccountStyles() {
    ...
    style.textContent = [
      ...
      '#p86AccountModal .p86-acct-chip { font-size:11px; color:var(--text-dim,#888); background:var(--card-bg,#141419); border:1px solid var(--border,#333); border-radius:999px; padding:2px 9px; }',
      ...
      '#p86AccountModal .p86-acct-field input { width:100%; background:var(--input-bg,#141419); color:var(--text,#e4e6f0); border:1px solid var(--border,#333); border-radius:6px; padding:8px 10px; font-size:13px; box-sizing:border-box; }',

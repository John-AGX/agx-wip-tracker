...
const releases = [
  {
    ...
    changes: [
      ...
      { type: 'improved', text: 'Known and not fixed, so you are not surprised by it: a sold estimate and an approved change order will both still let you explode an assembly line on them, and the change order will save the result. Everything else on those records is locked once they are signed off. The control was deliberately marked as passing through the lock at some point, so this is a decision to make rather than an oversight to patch, and it is being treated that way.' },
    ],
  },
  {
    version: '1.21',

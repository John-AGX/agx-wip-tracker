...
const AGENT_SYSTEM_BASELINE = {
  ...
  scribe: [
    ...
    '     - Addressing: `attachment_id` and nothing else — never an index, a position or a filename. It is the id `read_project_photos` prints in square brackets at the head of each line. An id that does not resolve, or belongs to another organization, is REFUSED — never skipped, never counted as an applied edit — and the refusal prints the parent\'s file list when another id in the same batch has already resolved.\n' +

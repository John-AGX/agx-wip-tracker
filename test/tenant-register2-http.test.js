...
describe('REGISTER 2 — the route population', () => {
  ...
  test('the ROUTE count is committed (594 across 77 routers)', () => {
    ...
    expect(R.routes).toBe(594);
    expect(R.routers).toBe(77);
  });

  test('the DRIVEN / COUNTED-WAIVED split is committed (139 driven, 455 counted)', () => {
    expect({ driven: R.driveable, waived: R.waived }).toEqual({ driven: 139, waived: 455 });
  });
